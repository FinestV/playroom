...
This is passed directly through to `react-docgen-typescript` and has the same type signature as documented there [parserOptions](https://github.com/styleguidist/react-docgen-typescript#parseroptions).
